function [noisePowerSpectrum] = specsub_nsBEN(filename,method,outfile)
%
%
...
noisePowerSpectrum = zeros(Nframes, nFFT/2 );
...
for n=1:Nframes 
   ...
   noisePowerSpectrum(n,1:nFFT/2) = noise_mu(1:nFFT/2);
