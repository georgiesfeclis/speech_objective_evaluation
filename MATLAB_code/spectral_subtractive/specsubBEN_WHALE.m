function [sBen] = specsubBEN_WHALE(filename,outfile)
...
enhanced_speech = winGain*xfinal;

whaleMax = max(abs(enhanced_speech));
enhanced_speech = 0.99 * enhanced_speech / whaleMax;
