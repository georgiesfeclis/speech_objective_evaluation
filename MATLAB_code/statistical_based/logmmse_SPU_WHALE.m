function logmmse_SPU_WHALE(filename,outfile,option)
...
whaleMax = max(abs(xfinal));
enhanced_speech = 0.99 * xfinal / whaleMax;

app = 4000 - length(enhanced_speech);
enhanced_speech = [enhanced_speech; zeros(app,1)];

audiowrite(outfile, enhanced_speech, Srate);
